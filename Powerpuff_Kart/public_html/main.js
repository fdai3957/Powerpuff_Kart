$(function () {
    ...
    var zuschauerGeometry = new THREE.BoxGeometry(2.5, 10, 2.5);
    var zuschauerMaterial= new THREE.MeshLambertMaterial({color: 0xFFE5B2});
    var zuschauer = new THREE.Mesh(zuschauerGeometry, zuschauerMaterial);    

    zuschauer.position.z = 0;
    zuschauer.position.x = 0;
    
    zuschauer.rotation.y = 1;
    scene.add(zuschauer);
    
    var armGeometry = new THREE.BoxGeometry(2.5, 1, 0.5);
    ...
    var armlGeometry = new THREE.BoxGeometry(10, 1, 0.5);
    var armlMaterial = new THREE.MeshLambertMaterial({color:0xFFE5B2});
    var arml = new THREE.Mesh(armlGeometry);
